...
################### INCLUDE FILE #################
	...
	$worksheet->setColumn(0,11,18);
	$worksheet->setColumn(0,12,18);
	$worksheet->setColumn(0,13,12);
	...
	$worksheet->write(5,6,"PERMANENT",$headerFormat);
		...
		foreach ($arrRentable as $valD) {
			...
			//}
			$worksheet->write($ctr,6,$valD['permanentTag'],$row1);
