        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="details">
          <tr>
              ...
              foreach($arrCompanies as $valComp) {
                ...
                End of Comment*/
                ?>
                 &nbsp;<span class="link" onClick="AddSTSDtl('undefined')" style="color:#F60;" ><span style="font-family: Verdana;">All Puregold</span></span> 
                 |&nbsp;<span class="link" onClick="AddSTSDtl('810')" style="color:#F60;" ><span style="font-family: Verdana;">All NE</span></span>
            </td>
            <td>&nbsp;
            </td>
          </tr>
