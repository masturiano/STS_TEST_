...
//****************************************************************************
	...
	$strCtr = "SELECT * FROM VIEWRASUMMARY WHERE PONUMBER = '". $_GET['po_number'] ."'";
	...
	$strHead = "SELECT * FROM VIEWRASUMMARY WHERE PONUMBER = '". $_GET['po_number'] ."'";
	...
	$strDetl = "SELECT * FROM VIEWRASUMMARYDETAIL WHERE PONUMBER = '". $_GET['po_number'] ."'";
	...
	function showHeader($pdf,$nrw,$npage,$npagemax)
	{
		...
		$pdf->Cell(195,$nrw + 3,"RECEIVER AUTHORIZATION LISTING",0,1,'C');
