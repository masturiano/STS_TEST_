...
function dateNextToProcess()////////////////////////////////////////////////////////
	...
	if(($do==""||$do=="processEOD")&&($while==""))
		{	echo "value='$dateNow' readonly='readonly'";	}
	elseif($do=="processEOD"&&($while=="error"||$while=="noProcess"))
...
if(whiles=="error")
	{
	alert("Sorry, you've already Processed the \"End of Day\" on Date "+dateToProcess);
	document.getElementById('dateToProcess').focus();
	document.getElementById('dateToProcess').select();
	}
else if(whiles=="noProcess")
	{
	alert("Sorry, there's no record to be Process on Date: "+dateToProcess);
	document.getElementById('dateToProcess').focus();
	document.getElementById('dateToProcess').select();
	}
