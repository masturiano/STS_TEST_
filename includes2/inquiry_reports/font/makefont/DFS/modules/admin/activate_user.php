<?
#Description: Admin Page - User Maintenance (Activate User)
#Author: Jhae Torres
...
<div id='frame_body'>
<form name='activate_user_form' id='activate_user_form' action='admin.trans.php' method='POST'>
	<div class='admin_header'>
		...
		<input type='submit' class='admin_button' name='search_activate_user' id='search_activate_user' value='SEARCH USER(S)' tabIndex='5'
	...
	<input type='button' class='admin_button' name='activate_user' id='activate_user' value='ACTIVATE USER(S)'
			onClick="assignTransaction(this.id); confirmActivateUser()" />
</form>
</div>
</body>