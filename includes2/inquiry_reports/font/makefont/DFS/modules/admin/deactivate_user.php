<?
#Description: Admin Page - User Maintenance (Deactivate User)
#Author: Jhae Torres
...
<div id='frame_body'>
<form name='deactivate_user_form' id='deactivate_user_form' action='admin.trans.php' method='POST'>
	<div class='admin_header'>
		...
		<input type='submit' class='admin_button' name='search_deactivate_user' id='search_deactivate_user' value='SEARCH USER(S)' tabIndex='5'
	...
	<input type='button' class='admin_button' name='deactivate_user' id='deactivate_user' value='DEACTIVATE USER(S)'
			onClick="assignTransaction(this.id); confirmDeactivateUser()" />
</form>
</div>
</body>