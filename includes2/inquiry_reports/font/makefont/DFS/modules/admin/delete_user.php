<?
#Description: Admin Page - User Maintenance (Delete User)
#Author: Jhae Torres
...
<div id='frame_body'>
<form name='delete_user_form' id='delete_user_form' action='admin.trans.php' method='POST'>
	<div class='admin_header'>
		...
		<input type='submit' class='admin_button' name='search_delete_user' id='search_delete_user' value='SEARCH USER(S)' tabIndex='5'
	...
	<input type='button' class='admin_button' name='delete_user' id='delete_user' value='DELETE USER(S)'
			onClick="assignTransaction(this.id); confirmDeleteUser()" />
</form>
</div>
</body>