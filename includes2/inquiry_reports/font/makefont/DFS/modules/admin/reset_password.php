<?
#Description: Admin Page - User Maintenance (Reset Password)
#Author: Jhae Torres
...
<div id='frame_body'>
<form name='reset_password_form' id='reset_password_form' action='admin.trans.php' method='POST'>
	<div class='admin_header'>
		...
		<input type='submit' class='admin_button' name='search_reset_password' id='search_reset_password' value='SEARCH USER(S)' tabIndex='5'
	...
	<input type='button' class='admin_button' name='reset_password' id='reset_password' value='RESET PASSWORD(S)'
			onClick="assignTransaction(this.id); confirmResetPassword()" />
</form>
</div>
</body>