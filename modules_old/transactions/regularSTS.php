...
switch($_GET['action']){	
	...
	case 'cmbSubClass':
		$transObj->DropDownMenu($transObj->makeArr($transObj->findSubClass($_GET['dept'],$_GET['class']),'stsSubCls','hierarchyDesc',''),'cmbSubClass','','class="selectBox" ');
	exit();
	break;
        ...
        <div id='dialogAdd' title='Add'>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                ...
                <tr>
                    ...
                    <td><? $transObj->DropDownMenu($arrMode,'cmbPayType','','class="selectBox"'); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><? $transObj->DropDownMenu($transObj->makeArr($transObj->getAllDept(),'stsDept','hierarchyDesc',''),'cmbDept','','class="selectBox"  onchange="loadClass(this.value);"'); ?></td>
                    <td class="hd">Sub-Class: </td>
                    <td id="tdSubClass"><select class="selectBox" id="cmbDummy2"><option></option></select></td>
                </tr>
                <tr>
               		<td class="hd">Class: </td>
                    <td id="tdClass" colspan="3"><select class="selectBox" id="cmbDummy2"><option></option></select></td>
                </tr>
                 <tr>
