...
class PDF extends FPDF
{
	...
	function Content($arrContract) {
		...
		$this->Cell(200,8,$arrContract['brnDesc'],0,0,'C');
		...
		$this->SetFont('Arial', '', '11');
		$this->Ln(1);
		$this->MultiCell(200,6,"1. Above amount is net of Expanded Witholding Tax.");
		$this->Ln(1);
