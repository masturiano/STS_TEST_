        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="details">
            <tr>
                <td width="1%" height="25">
                    <input type="checkbox" name="chAll" id="chAll" onClick="checkAllDtl();">
                </td>
                <td align="center"><strong>Branch</strong></td>
                <td align="center"><strong>Series</strong></td>
                <td align="center"><strong>Display Fee per Unit</strong></td>
                <td align="center"><strong>Total per Month</strong></td>
            ...
            <tr>
                ...
                <td align="center"><?=$val['specsAmount'];?></td>
                <td align="center"><?=$val['specsAmount'];?></td>
                <td align="center"><?=$val['specsAmount'];?></td>
                <td align="center">
                    <?php
                    $grossAmount = $val['specsAmount']+$val['specsAmount'];
                    echo $grossAmount
                    ?>
                </td>
            </tr>
