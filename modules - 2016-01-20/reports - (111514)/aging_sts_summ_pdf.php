...
class PDF extends FPDF
{
	function Main($arr)
	{
		...
		foreach($arr as $val) {
				...
				$this->Cell(5,8,'','0',0,'L');
				$this->Cell(25,8,number_format($val['current1'],2),'0',0,'R');
				$this->Cell(26,8,number_format($val['over30'],2),'0',0,'R');
				$this->Cell(26,8,number_format($val['over60'],2),'0',0,'R');
				$this->Cell(25,8,number_format($val['over90'],2),'0',0,'R');
				$this->Cell(25,8,number_format($val['amount'],2),'0',0,'R');
				$this->Cell(8,8,'','0',0,'L');
		...
		$this->Cell(5,8,'','0',0,'L');
		$this->Cell(25,8,number_format($totCur,2),'0',0,'R');
		$this->Cell(26,8,number_format($tot30,2),'0',0,'R');
		$this->Cell(25,8,number_format($tot60,2),'0',0,'R');
		$this->Cell(25,8,number_format($tot90,2),'0',0,'R');
		$this->Cell(25,8,number_format($totFund,2),'0',0,'R');
		///////////////
		$this->SetFont('Arial', '', '7');
	...
	function Header() {
		...
		$this->Cell(26,8,'Current','BT',0,'L');
		$this->Cell(26,8,'Over 30','BT',0,'L');
		$this->Cell(26,8,'Over 60','BT',0,'L');
		$this->Cell(26,8,'Over 90','BT',0,'L');
		$this->Cell(20,8,'Total','BT',0,'L');
