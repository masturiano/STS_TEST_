...
<div class="ui-widget-content" style="padding:5px;">
	<table width="100%" border="0" cellspacing="3" cellpadding="2">
       ...
       <tr>
            ...
            <td><? $reportsObj->DropDownMenu($reportsObj->makeArr($reportsObj->findGroup(),'grpCode','grpDesc',''),'cmbGroup','','class="selectBox"'); ?></td>
            ...
            <td><? $reportsObj->DropDownMenu($arrPayMode,'cmbPayMode','','class="selectBox"'); ?></td>
       </tr>
       <tr>
       </form>
