...
class maintenanceObj extends commonObj {
    ...
    */
	...
	function getRentableStores($id,$strCode,$grpCode){
        ...
        # Mydel edit filtering = and stsRefno is null to and (stsRefno is null OR tblDispDaDtlStr.endDate > tblDispDaDtlStr.endDate)
		$sql = "
            SELECT     tblDispDaDtlStr.displaySpecsId, tblDispDaDtlStr.dispDtlId, tblDispDaDtlStr.permanentTag, 
            tblDispDaDtlStr.usableTag, tblDispDaDtlStr.availabilityTag, tblDisplaySpecsDtl.dispDesc, tblDispDaDtlStr.strCode, 
            tblDispDaDtlStr.grpCode, tblDispDaDtlStr.locId, tblDisplaySpecs.displaySpecsDesc
            FROM         tblDispDaDtlStr INNER JOIN
            tblDisplaySpecsDtl ON tblDispDaDtlStr.dispDtlId = tblDisplaySpecsDtl.dispDtlId 
            AND tblDispDaDtlStr.displaySpecsId = tblDisplaySpecsDtl.displaySpecsId 
            INNER JOIN
            tblDisplaySpecs ON tblDispDaDtlStr.displaySpecsId = tblDisplaySpecs.displaySpecsId 
            WHERE tblDispDaDtlStr.strCode = '$strCode' 
            AND usableTag = 'Y' 
