...
FROM         tblDispDaDtlStr LEFT JOIN
            ...
            and (stsRefno is null OR tblDispDaDtlStr.endDate <= '".$dateTo."')
            ";
...
WHERE     tblDisplaySpecsDtl.displaySpecsId = '$dispSpecs' AND tblDispDaDtlStr.strCode = '$strCode' AND tblDispDaDtlStr.permanentTag = 'Y' AND ((tblDispDaDtlStr.usableTag = 'Y' AND tblDispDaDtlStr.availabilityTag = 'Y') OR (tblDispDaDtlStrHist.stsRefNo = '".$refNo."') )";*/
			...
			$sqla = "SELECT     tblDisplaySpecsDtl.dispDesc, tblDisplaySpecs.displaySpecsDesc, tblDispDaDtlStr.dispDtlId, tblDispDaDtlStrHist.stsRefNo, tblLocation.locDescription as locDescription
                ...
                AND ( (tblDispDaDtlStrHist.stsRefNo = '".$refNo."') )";
...
AND (((tblDispDaDtlStrHist.stsRefNo is null) OR (tblDispDaDtlStrHist.endDate > '".$dateTo."')) OR
((tblDispDaDtlStr.stsRefNo is null) OR (tblDispDaDtlStr.endDate > '".$dateTo."'))) 
