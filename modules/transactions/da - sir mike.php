...
function addEnhancer(){
	...
	$.ajax({
		url: 'daDtl2.php',
		type: "POST",
		data: "act=Details&refNo="+refNo+'&vatTag='+vatTag+'&display_specs_id=0',
		success: function(Data){
...
function editEnhancer(refNo,strCode){
	...
	$.ajax({
		url: 'daDtl2.php',
		type: "POST",
		data: "act=Details&refNo="+refNo+"&strCode="+strCode+'&vatTag='+vatTag+'&display_specs_id=0',
		beforeSend: function() {
...
function AddSTSDtl(compCode) {
	...
	$.ajax({
		url: 'daDtl2.php',
		type: "POST",
		data: "act=Details&refNo="+refNo+'&compCode='+compCode+'&vatTag='+vatTag+'&display_specs_id=0',
		beforeSend: function() {
        ...
        <div id='dialogAdd' title='Add'>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
                <tr>
                    ...
                    <td><div name="txtRefNo" id="txtRefNo"></div></td>
