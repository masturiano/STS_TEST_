...
switch($_GET['action']){	
	...
	case 'PrintDet':
			echo "window.open('stsSummaryUn_pdf.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
	
	case 'PrintDETXls':
			echo "window.open('stsSummaryUn_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">UNAPPROVED STS SUMMARY REPORT</h2>
