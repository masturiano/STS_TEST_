...
FROM         tblStsHdr LEFT OUTER JOIN
	...
	function getRegStsParticipants($refNo){
		$sql = "SELECT     tblStsDtl.stsRefno, tblStsDtl.compCode, tblStsDtl.strCode, tblStsDtl.stsAmt, tblStsDtl.stsNo, pg_pf.dbo.tblBranches.brnShortDesc, tblStsDtl.eventNo, CASE tblStsDtl.eventType
				WHEN 'R' THEN 'Regular'
				WHEN 'A' THEN 'Add Promo'
				ELSE tblStsDtl.eventType
		END AS eventType
